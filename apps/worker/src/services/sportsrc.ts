...
const SPORTSRC_BASE =
  process.env.SPORTSRC_BASE_URL?.replace(/\/$/, "") || "https://sportsrc.org";
...
function parseRssXml(xmlText: string, sourceName = "sportsrc"): NewsArticle[] {
  ...
  for (const itemXml of itemMatches) {
    ...
    const mediaMatch =
      itemXml.match(/url=["'](https?:\/\/[^"']+\.(?:jpg|jpeg|png|webp|gif))["']/i) ||
  ...
  return [
    {
      ...
      publishedAt: "2h ago",
      description:
        "Knockout fixtures are creating conversion opportunities across West African bookies as line movement accelerates.",
      urlToImage:
    ...
    },
    {
      ...
      publishedAt: "5h ago",
      description:
        "BetForge matcher cache updated for UK league sides to keep booking-code conversion accuracy high.",
      urlToImage:
    ...
    },
    {
      ...
      publishedAt: "1d ago",
      description:
        "How bettors in Nigeria and Ghana structure tickets before converting codes onto alternate books.",
      urlToImage:
        "https://images.unsplash.com/photo-1574629810360-7efbbe195018?auto=format&fit=crop&w=800&q=80",
      url: "https://sportsrc.org",
      source: "BetForge Desk",
